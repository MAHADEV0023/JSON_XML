...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnxmlparse=findViewById(R.id.button);
        btnjsonparse=findViewById(R.id.button2);
        btnxmlparse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(MainActivity.this,"Error ParsingXML",Toast.LENGTH_LONG).show();
                }
            }
        });
        btnjsonparse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(MainActivity.this,"Error inreading",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
